    ...
    extends TestSupport
{
  ...
  public void shouldHaveMeaningfulToString() {
    assertEquals("AssetBlobData{assetBlobId=1, blobRef=some-store@some-node:some-blob, blobSize=1, contentType='some-contentType', checksums={some-algo=some-checksum}, blobCreated=1970-01-01T00:00Z, createdBy='some-user', createdByIp='some-ip-address'}", assetBlob.toString());
    assertEquals("AssetData{assetId=1, path='/some-path', kind='some-kind', componentId=1, component=ComponentData{componentId=1, namespace='some-namespace', name='some-name', kind='some-kind', version='some-version'} AbstractRepositoryContent{repositoryId=null, attributes=NestedAttributesMap{parent=null, key='attributes', backing={}}, created=null, lastUpdated=null}, assetBlobId=1, assetBlob=AssetBlobData{assetBlobId=1, blobRef=some-store@some-node:some-blob, blobSize=1, contentType='some-contentType', checksums={some-algo=some-checksum}, blobCreated=1970-01-01T00:00Z, createdBy='some-user', createdByIp='some-ip-address'}, lastDownloaded=1970-01-01T00:00Z} AbstractRepositoryContent{repositoryId=null, attributes=NestedAttributesMap{parent=null, key='attributes', backing={}}, created=null, lastUpdated=null}", asset.toString());
    assertEquals("ComponentData{componentId=1, namespace='some-namespace', name='some-name', kind='some-kind', version='some-version'} AbstractRepositoryContent{repositoryId=null, attributes=NestedAttributesMap{parent=null, key='attributes', backing={}}, created=null, lastUpdated=null}", component.toString());
